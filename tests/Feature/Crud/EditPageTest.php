...
class EditPageTest extends PageTest
{
    ...
    {
        return route('adminify.crud.edit', ['model' => (new User())->getTable(), 'object' => $this->user]);
    }
    ...
    /** @test */
    function the_edit_page_displays_the_model()
    {
    ...
    /** @test */
    function the_edit_page_displays_all_the_fields()
    {
        $response = $this->actingAs($this->admin)->request();
    ...
    /** @test */
    function the_edit_page_does_not_show_the_hidden_fields()
    {
        $response = $this->actingAs($this->admin)->request();
    ...
    /** @test */
    function the_edit_page_displays_old_data()
    {
    ...
    /** @test */
    function the_edit_page_displays_error_messages()
    {
